...
Диаграма генерации событий для типов нажатий приведена ниже. Антидребезг в диаграмме отключён.

![Диаграма геренации событий](images/wb_press_events.png){width="400px"}
