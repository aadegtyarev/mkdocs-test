...
{%
   include-markdown "/mkdocs-test/relay/includes/mount-relay.md"
%}

{%
   include-markdown "/mkdocs-test/docs/relay/includes/mount-relay.md"
%}
...
[Список известных неисправностей](errata.md)
